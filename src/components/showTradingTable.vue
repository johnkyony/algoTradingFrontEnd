                ...
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    <thead class="text-black">
                      ...
                      <th>Action</th>
                      <th>UnrealizedPL</th>
                      <th> <a @click="closeAllTrades" class="btn btn-danger ">Close All Trades</a></th>
                    ...
                    <tbody>
                      <tr v-for="trade in trades" :key= trade.id>
                        ...
                        <td>{{trade.price}}</td>
                        <td>{{priceAction(trade.initialUnits)}}</td>
...
export default {
    ...
    methods: {
      ...
      closeAllTrades(){
        this.$store.dispatch("closeAllTrades" , this.trades)
      }, 
      priceAction(action){
        console.log(action)
        if (action === "1"){
